...
license_header = """// This file is generated by make.py script.
// It combines multiple source files into a single header and source file for easier inclusion in projects.
// This script is part of the l4dFiles project, which provides a simple interface for
...
# Include the json.hpp file content at the top of the buffer
json_h_path = os.path.join(RESULT_FOLDER, JSON_H_FILE)
if os.path.exists(json_h_path):
    with open(json_h_path, 'r') as f:
        json_h_content = f.read()
    buffer = json_h_content + '\n\n' + buffer
else:
